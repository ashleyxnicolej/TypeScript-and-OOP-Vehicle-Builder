...
class Cli {
    ...
    createTruck() {
        inquirer_1.default
            ...
            const truck = new Truck_js_1.default(Cli.generateVin(), answers.color, answers.make, answers.model, parseInt(answers.year), parseInt(answers.weight), parseInt(answers.topSpeed), parseInt(answers.towingCapacity), [] // Assuming an empty array for wheels
            );
