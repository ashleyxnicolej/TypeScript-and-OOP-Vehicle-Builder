...
class Cli {
    ...
    createTruck() {
        inquirer_1.default
            ...
            const truck = new Truck_js_1.default(Cli.generateVin(), answers.color, answers.make, answers.model, parseInt(answers.year, 10), parseInt(answers.weight, 10), parseInt(answers.topSpeed, 10), [new Wheel_js_1.default(20, "BrandA"), new Wheel_js_1.default(20, "BrandA"), new Wheel_js_1.default(20, "BrandA"), new Wheel_js_1.default(20, "BrandA")], parseInt(answers.towingCapacity, 10));
    ...
    createMotorbike() {
        inquirer_1.default
            ...
            const wheels = [new Wheel_js_1.default(18, "BrandA")];
    ...
    findVehicleToTow(truck) {
        inquirer_1.default
            ...
            if (vehicleToTow instanceof Truck_js_1.default) {
    ...
    performActions() {
        inquirer_1.default
            ...
            switch (answers.action) {
                ...
                case 'Tow a vehicle':
                    if (selectedVehicle instanceof Truck_js_1.default) { // Perform towing only if the selected vehicle is a truck
                ...
                case 'Do a wheelie':
                    if (selectedVehicle instanceof Motorbike_js_1.default) { // Perform wheelie only if the selected vehicle is a motorbike
